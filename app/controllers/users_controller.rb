...
class UsersController < ApplicationController
  before_action :authenticate_admin!, only: %i[index query_by_param]
  before_action :authenticate_user!, except: %i[index query_by_param email_reset_password reset_password show_reset_token]
